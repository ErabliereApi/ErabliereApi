...
namespace Depot.Sql.Migrations
{
    ...
    [Migration("20260715121115_AjoutFrequenceFacturationAbonnement")]
    partial class AjoutFrequenceFacturationAbonnement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ErabliereApi.Donnees.Abonnement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("FrequenceFacturation")
                        .HasMaxLength(50)
            ...
            modelBuilder.Entity("ErabliereApi.Donnees.ApiKey", b =>
                {
                    ...
                    b.Property<string>("AuthorizeUris")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("AuthorizeVerbs")
                        .HasMaxLength(25)
            ...
            modelBuilder.Entity("ErabliereApi.Donnees.Arbre", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ErabliereApi.Donnees.ChirpStackMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("ChirpStackSrvConfigId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ChirpStackSrvConfigId");

                    b.ToTable("ChirpstackMessageHistory");
                });

            modelBuilder.Entity("ErabliereApi.Donnees.ChirpStackSrvConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("DeviceClassEnabled")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<string>("DeviceProfileName")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<int>("KeepNLastMessage")
                        .HasColumnType("int");

                    b.Property<string>("LastDeviceSeen")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<DateTimeOffset?>("LastTimeSeen")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<TimeSpan?>("TimeToKeepLastMessage")
                        .HasColumnType("time");

                    b.HasKey("Id");

                    b.ToTable("ChirpstackSrvConfigs");
                });
            ...
            modelBuilder.Entity("ErabliereApi.Donnees.Entaille", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("IdArbre")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("IdErabliere")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("IdLigneTubelure")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ErabliereApi.Donnees.LigneTubelure", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("CoordonneesJson")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ErabliereApi.Donnees.MessagePart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ErabliereApi.Donnees.ChirpStackMessage", b =>
                {
                    b.HasOne("ErabliereApi.Donnees.ChirpStackSrvConfig", null)
                        .WithMany("ChirpStackMessagesHistory")
                        .HasForeignKey("ChirpStackSrvConfigId");
                });
            ...
            modelBuilder.Entity("ErabliereApi.Donnees.Entaille", b =>
                {
                    b.HasOne("ErabliereApi.Donnees.Arbre", "Arbre")
                        .WithMany("Entailles")
                        .HasForeignKey("IdArbre");
                    ...
                    b.HasOne("ErabliereApi.Donnees.LigneTubelure", "LigneTubelure")
                        .WithMany("Entailles")
                        .HasForeignKey("IdLigneTubelure");

                    b.Navigation("Arbre");

                    b.Navigation("Erabliere");

                    b.Navigation("LigneTubelure");
                });
            ...
            modelBuilder.Entity("ErabliereApi.Donnees.MessagePart", b =>
                {
                    b.HasOne("ErabliereApi.Donnees.Message", null)
                        .WithMany("MessageParts")
            ...
            modelBuilder.Entity("ErabliereApi.Donnees.ChirpStackSrvConfig", b =>
                {
                    b.Navigation("ChirpStackMessagesHistory");
                });
